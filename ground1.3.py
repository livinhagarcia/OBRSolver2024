...
def axis_correction(set_point_c = 40, set_point_s = 35 ):
    ...
    if corner == 3:
        ...
        if sd.reflection() < set_point_s:
            while sd.reflection() < set_point_s and sc.reflection() < set_point_s:
                motors.start_tank(-250,50)
                move_side = 'right'
        if se.reflection() < set_point_s : 
            while se.reflection() < set_point_s and sc.reflection() < set_point_s:
                motors.start_tank(50,-250)
                move_side = 'left'
        corner = 0
        ...
        if se_value > 60 and sd_value > 60:
            ...
            if checkGreen():
                ...
                if se_value > 80 and sd_value > 80 and sc_value > 80:
                    ...
                    if se.reflection() > sd.reflection(): 
                        darkest = "direita"
