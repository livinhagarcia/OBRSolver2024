...
def intersectionSolver(valores):
    ...
    # if sd.reflection() > 45 and se.reflection() > 45:
    #     print('fake green')
    #     if valores[0] == True and valores[1] == True:
    #         print('fake double')
    #     elif valores[0] == True:
    #         print('fake left')
    #         motors.move_tank(300, 200, 0)
    #     else:
    #         print('fake_right')
    #         motors.move_tank(300, 0, 200)
    #     return "failed"
    if valores[0] == True and valores[1] == True:
        print('dar voltinha')
...
logs = [name,move_side,log]
corner = 0
green_values = [[[162, 5, 30], [180, 87, 100]], [[164, 32, 30], [180, 87, 100]]]
mode = ""
